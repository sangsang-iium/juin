...
$ym = date('ym', BV_SERVER_TIME);

$data_dir = BV_DATA_PATH.'/editor/'.$ym;
$data_url = BV_DATA_URL.'/editor/'.$ym;

@mkdir($data_dir, BV_DIR_PERMISSION);
@chmod($data_dir, BV_DIR_PERMISSION);
