...
$LGD_RETURNURL  = BV_PLUGIN_URL.'/lgxpay/returnurl.php';
if( BV_IS_MOBILE ){
...
<link rel="stylesheet" href="<?php echo BV_CSS_URL;?>/default.css">
...
<form method="post" name ="LGD_PAYINFO" id="LGD_PAYINFO" action="<?php echo BV_LGXPAY_URL; ?>/AuthOnlyRes.php">
...
<div id="uplus_win" class="new_win mbskin">
    ...
    <p class="up_cmt"><img src="<?php echo BV_LGXPAY_URL; ?>/img/upluslogo.jpg" alt="">LG유플러스에 휴대폰 본인확인 요청 중입니다.</p>
    <div class="up_info">
        <a href="http://pgweb.uplus.co.kr:8080/pg/wmp/Home2009/skill/payment_error_center01.jsp" target="_blank"><img src="<?php echo BV_LGXPAY_URL; ?>/img/btn_gouplus.jpg" alt="U+ 오류 해결방법 바로가기"></a>
