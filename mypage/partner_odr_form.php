	...
	<section id="anc_sodr_list">
		...
		<div class="local_desc02 local_desc">
			<p>
				...
				<a href="javascript:win_open('<?php echo BV_MYPAGE_URL; ?>/partner_odr_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');" class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a>
			</p>
		</div>
		...
		<div class="tbl_head01">
			...
			<tr class="<?php echo $bg; ?>">
				...
				<td class="tal">
					<a href="<?php echo BV_MYPAGE_URL; ?>/page.php?code=partner_goods_form&w=u&gs_id=<?php echo $row['gs_id']; ?>" target="_blank"><?php echo get_text($gs['gname']); ?></a>
