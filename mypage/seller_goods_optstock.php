...
<h5 class="htag_title marb20 mart65">재고설정</h5>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<button type="button" onclick="js_chk_frm(this.form);" class="btn_large blue marl10">적용하기</button>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col" class="bd_none"><?php echo subject_sort_link('a.io_stock_qty',$q2); ?>재고수량</a></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2">
            <div class="btn_wrap">
                <a href="./page.php?code=seller_goods_form&w=u&gs_id=<?php echo $row['gs_id'].$qstr; ?>&page=<?php echo $page; ?>&bak=<?php echo $code; ?>" class="btn_fix bg_type2">
                    <span>수정</span>
                </a>
            </div>
        </td>
