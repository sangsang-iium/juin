...
if($w == "")
    goto_url(BV_MYPAGE_URL."/page.php?code=seller_goods_form&w=u&gs_id=$gs_id");
else if($w == "u")
    goto_url(BV_MYPAGE_URL."/page.php?code=seller_goods_form&w=u&gs_id=$gs_id$q1&page=$page&bak=$bak");
?>