...
require_once(BV_MSHOP_PATH.'/settle_lg.inc.php');
...
$LGD_RETURNURL			    = BV_MSHOP_URL.'/lg/returnurl.php';
$LGD_KVPMISPNOTEURL         = BV_MSHOP_URL.'/lg/note_url.php';
$LGD_KVPMISPWAPURL		    = BV_MSHOP_URL.'/lg/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = BV_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERWAPURL        = BV_MSHOP_URL.'/lg/returnurl.php';
$LGD_MTRANSFERCANCELURL     = BV_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = BV_MSHOP_URL.'/lg/note_url.php';
