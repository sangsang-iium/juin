        ...
        <div class="joinDetail-box">
          ...
          <div class="joinDetail-body">
            ...
            <div class="form-row">
              ...
              <div class="form-body input-button id-confirm">
                <input type="text" name="mb_name" value="<?php echo get_text($member['name']); ?>" id="reg_mb_name" <?php echo $required; ?> readonly class="<?php echo $required; ?> frm-input" size="20" placeholder="이름을 입력해주세요." autocapitalize="off">
                <?php
                $cert_str = '';
