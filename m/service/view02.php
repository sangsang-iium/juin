          ...
          <div class="ht-wrap">
            <div class="ht-view">
              ...
              <div class="ht-view-top">
                <p>Hi-Point My Shop 신한카드</p>
              </div>
              <!-- } top title -->
              <div class="service-imgbox">
                <img src="/src/img/service/service-view02_01.jpg">
              </div>
              <!-- btn { -->
              <div class="service-btn-wr">
                <ul class="i-col-4 service-btn-ul">
                  <li><button class="pop-btn pop-btn1">포인트 적립 혜택 상세보기</button></li>
                  <li><button class="pop-btn pop-btn2">할인혜택 상세보기</button></li>
                  <li><button class="pop-btn pop-btn3">금융우대혜택 상세보기</button></li>
                  <li><button class="pop-btn pop-btn4">세무/마케팅 혜택 상세보기</button></li>
                </ul>
              </div>
              <!-- } btn -->
              <div class="service-imgbox">
                <img src="/src/img/service/service-view02_02.jpg">
              </div>
    ...
    <div class="dfBox">
      <div class="container">
        <div class="service-apply__btns">
          <a href="/m/service/apply01.php" class="ui-btn round stBlack apply-btn">카드신청 바로가기</a>
