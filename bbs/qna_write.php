...
if($_POST['mode'] == 'w') {
	...
	alert("정상적으로 접수 되었습니다. 빠른 시간안에 답변드리겠습니다", BV_BBS_URL."/qna_list.php");
}
...
$form_action_url = BV_HTTPS_BBS_URL.'/qna_write.php';
include_once(BV_THEME_PATH.'/qna_write.skin.php');
