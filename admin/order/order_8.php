...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="button"  id="return_goods_change"  name="act_button" value="교환완료 처리" class="btn_medium red">  
...
$(function(){
	...
	$("#return_goods_change").on("click", function() {
		console.log("return_goods_change")
		var type = $(this).attr("id");
		var od_chk = new Array();
		var od_id = "";
		var $el_chk = $("input[name='chk[]']");
		...
		if(od_id == "") {
			...
			if(type == 'return_goods_change') {
				var url = "./order/order_return_money.php?code=8&od_id="+od_id; 
