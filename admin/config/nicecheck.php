...
<h5 class="htag_title">본인인증 / I-PIN 사용여부</h5>
<p class="gap20"></p>
<div class="tbl_frm01">
	<table>
	<colgroup>
...
<p class="gap50"></p>
<h5 class="htag_title">본인인증 / I-PIN 가입정보 설정</h5>
<p class="gap20"></p>
<div class="tbl_frm01">
	<table>
	<colgroup>
		...
		<td>
            <div class="write_address">
                <div class="file_wrap address">
                    ...
                    <a href="http://ok-name.co.kr/acs/non/bizindex.jsp" target="_blank" class="btn_file">KCB 서비스 신청</a>
                </div>
            </div>
            <ul class="cnt_list step01 mart10">
                <li>KCB 회원사ID를 입력해 주십시오.</li>
                <li>서비스에 가입되어 있지 않다면, KCB와 계약체결 후 회원사ID를 발급 받으실 수 있습니다.</li>
                <li>이용하시려는 서비스에 대한 계약을 아이핀, 휴대폰 본인확인 각각 체결해주셔야 합니다.</li>
                <li>아이핀 본인확인 테스트의 경우에는 KCB 회원사ID가 필요 없으나, 휴대폰 본인확인 테스트의 경우 KCB 에서 따로 발급 받으셔야 합니다.</li>
            </ul>
		...
		<td>
            <div class="write_address">
                <div class="file_wrap address">
                    ...
                    <a href="https://www.kcp.co.kr/service.payment.certRequest.do?cmd=certApply" target="_blank" class="btn_file">NHN KCP 휴대폰 본인인증 서비스 신청</a>
                </div>
            </div>
			<ul class="cnt_list step01 mart10">
                <li>NHN KCP 사이트코드를 입력해 주십시오.</li>
                <li>서비스에 가입되어 있지 않다면, 본인인증 서비스 신청페이지에서 서비스 신청 후 사이트코드를 발급 받으실 수 있습니다.</li>
            </ul>
		...
		<td>
            <div class="write_address">
                <div class="file_wrap address">
			        ...
			        <a href="http://ecredit.uplus.co.kr/" target="_blank" class="btn_file">LG유플러스 본인인증 서비스 신청</a>
                </div>
            </div>
			<ul class="cnt_list step01 mart10">
                <li>LG유플러스 상점아이디를 입력해 주십시오.<br>서비스에 가입되어 있지 않다면, 본인인증 서비스 신청페이지에서 서비스 신청 후 상점아이디를 발급 받으실 수 있습니다.</li>
                <li class="fc_red">LG유플러스 휴대폰본인인증은 ActiveX 설치가 필요하므로 Internet Explorer 에서만 사용할 수 있습니다.</li>
            </ul>
	...
	<tr>
		...
		<td>
            ...
            <ul class="cnt_list step01 mart10">
                <li>예) 95160cce09854ef44d2edb2bfb05f9f3</li>
                <li>LG유플러스 상점MertKey는 <strong>[계약정보 &gt; 상점정보관리 &gt; 시스템연동정보]</strong>에서 확인하실 수 있습니다.</li>
            </ul>
...
<p class="gap50"></p>
<h5 class="htag_title">당일 이용제한 설정</h5>
<p class="gap20"></p>
<div class="tbl_frm01">
	<table>
	<colgroup>
	...
	<tr>
		...
		<td>
            <div class="tel_input">
                <input type="text" name="cf_cert_limit" value="<?php echo $config['cf_cert_limit']; ?>" id="cf_cert_limit" class="frm_input w80" size="5"> 
                <p>회</p>
            </div>
            <ul class="cnt_list step01 mart10">
                <li>하루동안 아이핀과 휴대폰 본인인증 인증 이용회수를 제한할 수 있습니다.</li>
                <li>회수제한은 실서비스에서 아이핀과 휴대폰 본인인증 인증에 개별 적용됩니다.</li>
                <li class="fc_084">0 으로 설정하시면 회수제한이 적용되지 않습니다.</li>
            </ul>
	...
	<tr>
		...
		<td>
            ...
            <ul class="cnt_list step01 mart10">
                <li>회원가입시 본인인증을 필수로 할지 설정합니다.</li>
                <li>필수로 설정하시면 본인인증을 하지 않은 경우 회원가입이 안됩니다.</li>
            </ul>
...
<div class="text_box btn_type mart50">
    ...
    <ul class="cnt_list step01">
        <li>본인인증을 사용하실 경우 회원가입시 휴대폰인증 및 아이핀인증이 작동 됩니다.</li>
        <li>실명과 휴대폰번호 그리고 본인인증 당시에 성인인지의 여부를 저장합니다.</li>
        <li>게시판의 경우 본인확인 또는 성인여부를 따져 게시물 조회 및 쓰기 권한을 줄 수 있습니다.</li>
        <li>본인인증은 <strong>[코리아크레딧뷰로, KCP, LG유플러스]</strong>중에서 서비스업체 계약담당자와 반드시 계약체결 이후 사용하셔야 합니다.</li>
    </ul>
    <h6 class="htag_title mart20">[관련법규]</h6>
    <ul class="cnt_list step01 mart10 padl20">
        <li class="fc_red">정보통신망 이용 촉진 및 정보보호 등에 관한 법률 제 23조의 2 (주민등록번호의 사용제한)</li>
        <li>① 정보통신서비스 제공자는 다음 각 호에 해당하는 경우를 제외하고는 이용자의 주민등록번호를 수집.이용할 수 없다.
            <ol class="cnt_list number_type">
                <li><span class="txt">제 23조의 3에 따라 본인확인기관으로 지정받은 경우</span></li>
                <li><span class="txt">법령에서 이용자의 주민등록번호 수집, 이용을 허용하는 경우</span></li>
                <li><span class="txt">영업상 목적을 위하여 이용자의 주민등록번호 수집.이용이 불가피한 정보통신 서비스 제공자로서 방송통신위원회가 고시하는 경우</span></li>
            </ol>
        </li>
        <li>② 제1항 제2호 및 제3호에 따라 주민등록번호를 수집.
            <ul class="cnt_list step02">
                <li>이용할 수 있는 경우에도 이용자의 주민등록을 사용하지 아니하고 본인을 확인하는 방법(이하 "대체수단"이라 한다)을 제공하여야 한다.</li>
            </ul>
        </li>
        <li>(제76조 과태료) 제23조의2를 위반하여 필요한 조치를 하지 아니한 자는 3천만 원 이하의 과태료를 부과</li>
        <li>(부칙 제2조 주민등록번호 수집, 이용 제한에 관한 경과조치) 기존 보유 주민번호는 2014년 8월 17일 까지 파기</li>
    </ul>
</div>
