...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="<?php echo BV_LIB_URL; ?>/Excel/memberexcel.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a></td>
	</tr>
	<tr>
...
function fmemberexcel_submit(f)
{
	...
	f.action = bv_admin_url+"/member.php?code=xls_update_240520";
	return true;
}
</script>
