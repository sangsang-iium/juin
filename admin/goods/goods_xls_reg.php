	...
	<tr>
		...
		<td>
            <div class="btn_wrap tal">
							<a href="<?php echo BV_LIB_URL; ?>/Excel/itemexcelv4.xls" class="fbtn xls"><span>상품등록 샘플 다운로드</span></a>
							<!-- <a href="<?php echo BV_LIB_URL; ?>/Excel/areaitems.xls" class="fbtn xls"><span>지역정보 다운로드</span></a> -->
