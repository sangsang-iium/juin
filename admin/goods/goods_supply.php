	...
	<tr>
		...
		<td colspan="3">
            <div class="tel_input">
                ...
                <input type="text" name="stx" value="<?php echo $stx; ?>" class="frm_input w70p" size="30">
            </div>
        </td>
	</tr>
	<tr>
...
<div class="tbl_head01">
	...
	<thead>
	<tr>
		<th scope="col" rowspan="2" class="bd_none"><input type="checkbox" name="chkall" value="1" onclick="check_all(this.form);"></th>
		...
		<th scope="col" colspan="3" class="th_bg bd_none">가격정보</th>
...
function downloadExcel() {
	...
	window.location.href = './goods/goods_supply_excel.php?<?php echo $q1; ?>&selected_ids=' + ids;
}
</script>