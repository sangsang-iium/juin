...
$value['supply_type']	  = ($_POST['supply_type']); //정산방식 추가 _20240426_SY
...
if($w == "")
    goto_url(BV_ADMIN_URL."/goods.php?code=form&w=u&gs_id=$gs_id");
else if($w == "u")
    goto_url(BV_ADMIN_URL."/goods.php?code=form&w=u&gs_id=$gs_id$q1&page=$page&bak=$bak");
?>