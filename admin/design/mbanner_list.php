...
<p class="gap50"></p>
<h5 class="htag_title">모바일스킨 (<?php echo $super['mobile_theme']; ?>) 배너목록</h5>
<p class="gap20"></p>
<div class="local_ov">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./design.php?code=mbanner_form&w=u&bn_id=$bn_id$qstr&page=$page' class=\"btn_fix bg_type2\"><span>수정</span></a>";
