	...
	<section id="anc_sodr_list">
		...
		<div class="local_desc02 local_desc">
			<p>
				...
				<a href="javascript:win_open('<?php echo BV_ADMIN_URL; ?>/order/order_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');" class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a>
			</p>
		</div>
