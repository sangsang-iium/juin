...
<div class="tbl_head02">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><a href="<?php echo BV_ADMIN_URL; ?>/partner/pt_category.php?mb_id=<?php echo $row['id']; ?>" onclick="win_open(this,'pop_category','900','687','yes');return false;" class="btn_small bx-white">카테고리</a></td>
	</tr>
	<?php
	}
	if($i==0)
