...
require_once(BV_SHOP_PATH.'/inicis/libs/HttpClient.php');
require_once(BV_SHOP_PATH.'/inicis/libs/json_lib.php');
...
try {
    ...
    if (strcmp('0000', $_REQUEST['resultCode']) == 0) {
        ...
        try {
			...
			$order_action_url = BV_SHOP_URL.'/orderformresult.php';
			$page_return_url  = BV_SHOP_URL.'/orderinicis.php?od_id='.$oid;
            ...
            if ((strcmp('0000', $resultMap['resultCode']) == 0) && (strcmp($secureSignature, $resultMap['authSignature']) == 0) ) { //결제보안 추가 2016-05-18
                ...
                require BV_SHOP_PATH.'/inicis/INIStdPayResult.php';
                exit;
            } else {
