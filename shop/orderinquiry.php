...
if(BV_IS_MOBILE) {
	goto_url(BV_MSHOP_URL.'/orderinquiry.php');
}
...
if(!$is_member) {
    ...
    if($row['od_id']) {
        ...
        goto_url(BV_SHOP_URL.'/orderinquiryview.php?od_id='.$row['od_id'].'&uid='.$uid);
    }
}
...
include_once(BV_THEME_PATH.'/orderinquiry.skin.php');
